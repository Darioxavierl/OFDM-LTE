"""
Widgets personalizados para la GUI OFDM
"""
import numpy as np
...
class MetricsPanel(QWidget):
    ...
    def init_ui(self):
        ...
        # Labels para métricas (solo BER, PAPR y Tiempo)
        ...
        for label in [self.ber_label, self.papr_label, self.time_label]:
    ...
    def update_metrics(self, metrics):
        """Actualiza las métricas mostradas (solo BER, PAPR, Tiempo)"""
        if 'ber' in metrics:
